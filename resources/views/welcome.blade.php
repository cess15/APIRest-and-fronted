...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="container">
        <p><b>Nombre:
            </b><span>Cesar Lata Jacome
            </span></p>
        <p><b>Fecha: </b><span>27 de julio de 2021 a las 16:43 p.m</span></p>
    </div>
    <div class="container">
        <h1>Datos del Estudiante</h1>
        <ul>
            <li>Nombres: Cesar Lata Jacome</li>
            <li>Carrera: Sistemas</li>
            <li>Semestre: Decimo</li>
        </ul>
        <h1>Invitados</h1>
        <ul>
            <li>Nombres: Juan</li>
            <li>Nombres: Roberto</li>
            <li>Nombres: Francisco</li>
        </ul>
